  ...
  return (
    <div className='fixed bottom-0 w-[720px] h-5/6 flex flex-col items-center px-8 pt-8 bg-tertiary-grey rounded-t-xl overflow-y-auto'>
      <div className='flex flex-col gap-4 items-center'>
        <p className='text-lg font-medium'>Congratulations! You completed</p>
        <p className='text-4xl font-titan'>{unitContent.title}</p>
      </div>

      <Link
        href={`/course/${unitContent.courseId}/${nextUnit}`}
